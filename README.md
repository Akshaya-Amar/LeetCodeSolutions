...
| # | Title | Solution | Complexity | Difficulty |
|:---:| ----- | :--------: | :----------: | :----------: |
|5|[Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/)|[JAVA](./Java/LongestPalindromicSubstring.java) |Time - **O(n ^ 2)** <br>Space - **O(n)** | Medium
