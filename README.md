...
|258|[Add Digits](https://leetcode.com/problems/add-digits/)| [C++](./C++/AddBinary.cpp) <br> [JAVA](./Java/AddBinary.java) | Time - **O(log<sub>10</sub>(n))** <br>Space - **O(1)** | Easy | Simulation, Number Theory
