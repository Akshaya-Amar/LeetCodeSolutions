...
|:---:| ----- | :--------: | :----------: | :----------: |
|9|[Palindrome Number](https://leetcode.com/problems/palindrome-number/)| [Link](https://leetcode.com/problems/palindrome-number/discuss/1238021/Java%3A-In-place-0(1)-Space-or-Fast-or-No-Overflow-or-Efficient-Solution-with-Explanation) | Time - **O(log<sub>10</sub>(N))** <br>Space - **O(1)**| Easy
...
|1365|[How Many Numbers Are Smaller Than the Current Number](https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/)| [C++](./C++/HowManyNumbersAreSmallerThantheCurrentNumber.cpp) <br>[Java](./Java/HowManyNumbersAreSmallerThantheCurrentNumber.java) |Time - **O(N)** <br>Space - **O(N)**| Easy
